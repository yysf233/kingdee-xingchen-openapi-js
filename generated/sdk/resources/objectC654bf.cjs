...
const ENDPOINTS = {
  ...
  "title": "销售汇总表列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/sal/sal_summary_rpt_ims",
  "isRelative": false,
  "docPath": "docs/销售汇总表列表.md"
}
};
...
module.exports = function createObjectC654bfApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
