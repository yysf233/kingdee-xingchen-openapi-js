...
const ENDPOINTS = {
  ...
  "title": "组装单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_assemble",
  "isRelative": false,
  "docPath": "docs/组装单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "组装单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_assemble_detail",
  "isRelative": false,
  "docPath": "docs/组装单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "组装单保存",
...
module.exports = function createObject0779bdApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
