...
const ENDPOINTS = {
  ...
  "title": "零售结存单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/ls/balance_bill",
  "isRelative": false,
  "docPath": "docs/零售结存单列表.md"
}
};
...
module.exports = function createObject7fcfaaApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
