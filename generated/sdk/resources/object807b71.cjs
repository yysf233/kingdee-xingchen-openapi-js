...
const ENDPOINTS = {
  ...
  "title": "收入类别列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/income_type",
  "isRelative": false,
  "docPath": "docs/收入类别列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "收入类别保存",
...
module.exports = function createObject807b71Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
