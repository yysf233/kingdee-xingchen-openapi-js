...
write:upsert: 外部单据自定义字段设置 [POST https://api.kingdee.com/jdy/v2/fi/custom_field_save]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "外部单据列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/virtual",
  "isRelative": false,
  "docPath": "docs/外部单据列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "外部单据详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/virtual_detail",
  "isRelative": false,
  "docPath": "docs/外部单据详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "外部单据保存",
...
module.exports = function createObjectEcecb8Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
