...
const ENDPOINTS = {
  ...
  "title": "其他支出单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ap_other_credit",
  "isRelative": false,
  "docPath": "docs/其他支出单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "其他支出单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ap_other_credit_detail",
  "isRelative": false,
  "docPath": "docs/其他支出单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "其他支出单保存",
...
module.exports = function createObject9e390eApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
