...
const ENDPOINTS = {
  ...
  "title": "结算期限列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/settling_term",
  "isRelative": false,
  "docPath": "docs/结算期限列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "结算期限详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/settling_term_detail",
  "isRelative": false,
  "docPath": "docs/结算期限详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "结算期限保存",
...
module.exports = function createObject8cc2d3Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
