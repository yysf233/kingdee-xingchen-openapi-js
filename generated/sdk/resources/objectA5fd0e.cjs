...
const ENDPOINTS = {
  ...
  "title": "销售退货单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_in_bound",
  "isRelative": false,
  "docPath": "docs/销售退货单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "销售退货单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_in_bound_detail",
  "isRelative": false,
  "docPath": "docs/销售退货单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "销售退货单保存",
...
module.exports = function createObjectA5fd0eApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
