...
const ENDPOINTS = {
  ...
  "title": "辅助属性列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/aux_attribute",
  "isRelative": false,
  "docPath": "docs/辅助属性列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "辅助属性保存",
...
module.exports = function createObject846d51Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
