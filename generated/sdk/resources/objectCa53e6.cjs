...
read:list: 利润表 [GET https://api.kingdee.com/jdy/v2/fi/profit_report]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "资产负债表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/balancesheet",
  "isRelative": false,
  "docPath": "docs/资产负债表.md"
}
};
...
module.exports = function createObjectCa53e6Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
