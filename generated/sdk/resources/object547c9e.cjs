...
read:list: 出纳资金收支趋势 [GET https://api.kingdee.com/jdy/v2/fi/ca_debit_and_credit_trend]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "出纳资金余额",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/ca_account_balance",
  "isRelative": false,
  "docPath": "docs/出纳资金余额.md"
}
};
...
module.exports = function createObject547c9eApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
