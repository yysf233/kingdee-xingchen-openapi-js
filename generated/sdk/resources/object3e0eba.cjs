...
const ENDPOINTS = {
  ...
  "title": "付款单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ap_credit",
  "isRelative": false,
  "docPath": "docs/付款单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "付款单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ap_credit_detail",
  "isRelative": false,
  "docPath": "docs/付款单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "付款单保存",
...
module.exports = function createObject3e0ebaApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
