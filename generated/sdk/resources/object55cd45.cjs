...
const ENDPOINTS = {
  ...
  "title": "分量盘点单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_multi_check",
  "isRelative": false,
  "docPath": "docs/分量盘点单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "分量盘点单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_multi_check_detail",
  "isRelative": false,
  "docPath": "docs/分量盘点单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "分量盘点单保存",
...
module.exports = function createObject55cd45Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
