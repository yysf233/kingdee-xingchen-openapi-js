...
const ENDPOINTS = {
  ...
  "title": "其他收入退款单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_other_credit_ret",
  "isRelative": false,
  "docPath": "docs/其他收入退款单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "其他收入退款单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_other_credit_ret_detail",
  "isRelative": false,
  "docPath": "docs/其他收入退款单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "其他收入退款单保存",
...
module.exports = function createObject5b7c2fApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
