...
const ENDPOINTS = {
  ...
  "title": "委外产品退货单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/subm_prod_rtn",
  "isRelative": false,
  "docPath": "docs/委外产品退货单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "委外产品退货单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/subm_prod_rtn_detail",
  "isRelative": false,
  "docPath": "docs/委外产品退货单详情.md"
}
};
...
module.exports = function createObjectDb2d5aApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
