...
const ENDPOINTS = {
  ...
  "title": "科目列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/account",
  "isRelative": false,
  "docPath": "docs/科目列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "科目详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/account_detail",
  "isRelative": false,
  "docPath": "docs/科目详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "科目保存",
...
module.exports = function createObject88c729Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
