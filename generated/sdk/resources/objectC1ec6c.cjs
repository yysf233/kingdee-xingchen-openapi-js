...
read:list: 会员优惠券查询 [GET https://api.kingdee.com/jdy/v2/ls/coupons]; 会员级别列表 [GET https://api.kingdee.com/jdy/v2/ls/mb_level]; 领劵中心查询 [GET https://api.kingdee.com/jdy/v2/ls/coupon_center]; 会员账户余额查询 [GET https://api.kingdee.com/jdy/v2/ls/account_balance_info]
write:upsert: 会员充值 [POST https://api.kingdee.com/jdy/v2/ls/mall_recharge]; 会员积分调整 [POST https://api.kingdee.com/jdy/v2/ls/integral_adjust]; 优惠券发放(领用) [POST https://api.kingdee.com/jdy/v2/ls/coupons_distribute]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "会员列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/ls/member",
  "isRelative": false,
  "docPath": "docs/会员列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "会员详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/ls/member_detail",
  "isRelative": false,
  "docPath": "docs/会员详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "会员保存",
...
module.exports = function createObjectC1ec6cApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
