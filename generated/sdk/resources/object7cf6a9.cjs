...
const ENDPOINTS = {
  ...
  "title": "工资项目列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/sa_item",
  "isRelative": false,
  "docPath": "docs/工资项目列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "工资项目保存",
...
module.exports = function createObject7cf6a9Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
