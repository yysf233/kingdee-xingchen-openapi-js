...
const ENDPOINTS = {
  ...
  "title": "组装拆卸模板列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/assemble_tpl",
  "isRelative": false,
  "docPath": "docs/组装拆卸模板列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "组装拆卸模板详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/assemble_tpl_detail",
  "isRelative": false,
  "docPath": "docs/组装拆卸模板详情.md"
}
};
...
module.exports = function createObject3c6131Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
