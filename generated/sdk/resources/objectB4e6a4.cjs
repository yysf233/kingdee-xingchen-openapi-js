...
read:list: 库存同步列表 [GET https://api.kingdee.com/jdy/v2/inv/inv_synchronous]; 商品仓库库存查询 [GET https://api.kingdee.com/jdy/v2/scm/inventory_stock]; 库存查询表 [GET https://api.kingdee.com/jdy/v2/inv/inv_inventory_ims]; 序列号跟踪表列表 [GET https://api.kingdee.com/jdy/v2/scm/inv_serial_track_bill_list]; 序列号状态表列表 [GET https://api.kingdee.com/jdy/v2/scm/inventory_serial_status]; 批次保质期及库存列表 [GET https://api.kingdee.com/jdy/v2/scm/batch_kfperiod_inventory]
write:upsert: 库存占用释放 [POST https://api.kingdee.com/jdy/v2/scm/inv_release_occupy]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "商品库存列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inventory",
  "isRelative": false,
  "docPath": "docs/商品库存列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "商品收发明细表列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_detail",
  "isRelative": false,
  "docPath": "docs/商品收发明细表列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "库存占用",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_occupy",
  "isRelative": false,
  "docPath": "docs/库存占用.md"
}
};
...
module.exports = function createObjectB4e6a4Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
  ...
  async function verifyDelete(action, criteria, opts = {}) {
    if (true && criteria && criteria.id !== undefined) {
      try {
