...
const ENDPOINTS = {
  ...
  "title": "委外发料单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/mat_issue_order",
  "isRelative": false,
  "docPath": "docs/委外发料单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "委外发料单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/mat_issue_order_detail",
  "isRelative": false,
  "docPath": "docs/委外发料单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "委外发料单保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/mat_issue_order_save",
  "isRelative": false,
  "docPath": "docs/委外发料单保存.md"
}
};
...
module.exports = function createObject6bd4caApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
