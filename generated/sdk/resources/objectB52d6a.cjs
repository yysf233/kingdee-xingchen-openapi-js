...
const ENDPOINTS = {
  ...
  "title": "采购退货单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_ret",
  "isRelative": false,
  "docPath": "docs/采购退货单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "采购退货单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_ret_detail",
  "isRelative": false,
  "docPath": "docs/采购退货单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "采购退货单保存",
...
module.exports = function createObjectB52d6aApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
