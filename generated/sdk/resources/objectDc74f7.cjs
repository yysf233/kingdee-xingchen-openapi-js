...
const ENDPOINTS = {
  ...
  "title": "采购发票单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_invoice",
  "isRelative": false,
  "docPath": "docs/采购发票单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "采购发票单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_invoice_detail",
  "isRelative": false,
  "docPath": "docs/采购发票单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "采购发票单保存",
...
module.exports = function createObjectDc74f7Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
