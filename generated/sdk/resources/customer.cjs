...
const ENDPOINTS = {
  ...
  "title": "客户列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/customer",
  "isRelative": false,
  ...
  "title": "客户详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/customer_detail",
  "isRelative": false,
...
module.exports = function createCustomerApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
