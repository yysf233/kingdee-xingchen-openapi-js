...
read:list: 商品标签列表 [GET https://api.kingdee.com/jdy/v2/bd/material_label]
write:upsert: 商品标签保存 [POST https://api.kingdee.com/jdy/v2/bd/material_label]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "标签列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/label",
  "isRelative": false,
  "docPath": "docs/标签列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "标签详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/label_detail",
  "isRelative": false,
  "docPath": "docs/标签详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "标签保存",
...
module.exports = function createObject71ca4eApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
