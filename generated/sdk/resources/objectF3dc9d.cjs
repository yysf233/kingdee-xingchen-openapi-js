...
const ENDPOINTS = {
  ...
  "title": "资产清理列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_clean",
  "isRelative": false,
  "docPath": "docs/资产清理列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "资产清理详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_clean_detail",
  "isRelative": false,
  "docPath": "docs/资产清理详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "资产清理保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_clean_save",
  "isRelative": false,
  "docPath": "docs/资产清理保存.md"
}
};
...
module.exports = function createObjectF3dc9dApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
