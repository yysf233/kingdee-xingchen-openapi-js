...
const ENDPOINTS = {
  ...
  "title": "配方列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/ls/formula",
  "isRelative": false,
  "docPath": "docs/配方列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "配方保存",
...
module.exports = function createObject4b435bApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
