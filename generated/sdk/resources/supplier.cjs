...
const ENDPOINTS = {
  ...
  "title": "供应商列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/supplier",
  "isRelative": false,
  "docPath": "docs/供应商列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "供应商详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/supplier_detail",
  "isRelative": false,
  "docPath": "docs/供应商详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "供应商保存",
...
module.exports = function createSupplierApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
