...
const ENDPOINTS = {
  ...
  "title": "产品退库单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_product_ret",
  "isRelative": false,
  "docPath": "docs/产品退库单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "产品退库单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_product_ret_detail",
  "isRelative": false,
  "docPath": "docs/产品退库单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "产品退库单保存",
...
module.exports = function createObject49964aApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
