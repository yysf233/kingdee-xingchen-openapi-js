...
const ENDPOINTS = {
  ...
  "title": "变动方式分类列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_modegroup",
  "isRelative": false,
  "docPath": "docs/变动方式分类列表.md"
}
};
...
module.exports = function createObject391501Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
