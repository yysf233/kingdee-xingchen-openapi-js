...
const ENDPOINTS = {
  ...
  "title": "支出类别列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/payout_type",
  "isRelative": false,
  "docPath": "docs/支出类别列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "支出类别保存",
...
module.exports = function createObjectD31ffdApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
