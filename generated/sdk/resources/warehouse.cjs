...
const ENDPOINTS = {
  ...
  "title": "仓库列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/store",
  "isRelative": false,
  "docPath": "docs/仓库列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "仓库详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/store_detail",
  "isRelative": false,
  "docPath": "docs/仓库详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "仓库保存",
...
module.exports = function createWarehouseApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
