...
read:list: 商品上下架列表 [GET https://api.kingdee.com/jdy/v2/ls/shelf]; 发货单列表 [GET https://api.kingdee.com/jdy/v2/ls/delivery]; 门店商品列表 [GET https://api.kingdee.com/jdy/v2/ls/material]; 优惠券核销 [GET https://api.kingdee.com/jdy/v2/ls/coupons_write_off]
write:upsert: 预核销 [POST https://api.kingdee.com/jdy/v2/ls/mall_pre_write_off]; 反预核销 [POST https://api.kingdee.com/jdy/v2/ls/mall_pre_write_off_cancel]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "门店列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/ls/store",
  "isRelative": false,
  "docPath": "docs/门店列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "门店保存",
...
module.exports = function createObjectA7fb26Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
