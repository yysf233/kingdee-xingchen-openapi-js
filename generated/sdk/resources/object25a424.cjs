...
const ENDPOINTS = {
  ...
  "title": "仓位列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/spaces",
  "isRelative": false,
  "docPath": "docs/仓位列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "仓位详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/space_detail",
  "isRelative": false,
  "docPath": "docs/仓位详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "仓位保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/space",
  "isRelative": false,
  "docPath": "docs/仓位保存.md"
}
};
...
module.exports = function createObject25a424Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
