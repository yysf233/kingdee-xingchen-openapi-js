...
const ENDPOINTS = {
  ...
  "title": "产品入库单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_product",
  "isRelative": false,
  "docPath": "docs/产品入库单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "产品入库单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_product_detail",
  "isRelative": false,
  "docPath": "docs/产品入库单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "产品入库单保存",
...
module.exports = function createObject14f417Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
