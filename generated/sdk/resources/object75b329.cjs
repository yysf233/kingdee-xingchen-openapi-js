...
const ENDPOINTS = {
  ...
  "title": "凭证字列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/voucher_type",
  "isRelative": false,
  "docPath": "docs/凭证字列表.md"
}
};
...
module.exports = function createObject75b329Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
