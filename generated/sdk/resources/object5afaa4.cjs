...
const ENDPOINTS = {
  ...
  "title": "标签分类列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/label_group",
  "isRelative": false,
  "docPath": "docs/标签分类列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "标签分类保存",
...
module.exports = function createObject5afaa4Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
