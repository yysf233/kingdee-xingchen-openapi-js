...
const ENDPOINTS = {
  ...
  "title": "预收款单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_pre_credit",
  "isRelative": false,
  "docPath": "docs/预收款单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "预收款单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_pre_credit_detail",
  "isRelative": false,
  "docPath": "docs/预收款单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "预收款单保存",
...
module.exports = function createObject5e8eabApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
