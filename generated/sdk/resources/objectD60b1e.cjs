...
const ENDPOINTS = {
  ...
  "title": "收款退款单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_credit_ret",
  "isRelative": false,
  "docPath": "docs/收款退款单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "收款退款单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_credit_ret_detail",
  "isRelative": false,
  "docPath": "docs/收款退款单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "收款退款单保存",
...
module.exports = function createObjectD60b1eApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
