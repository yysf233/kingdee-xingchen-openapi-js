...
const ENDPOINTS = {
  ...
  "title": "委外退料单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/mat_order_ret",
  "isRelative": false,
  "docPath": "docs/委外退料单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "委外退料单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/mat_order_ret_detail",
  "isRelative": false,
  "docPath": "docs/委外退料单详情.md"
}
};
...
module.exports = function createObject3bdff6Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
