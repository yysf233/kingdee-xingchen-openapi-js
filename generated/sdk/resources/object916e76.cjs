...
const ENDPOINTS = {
  ...
  "title": "资产类别列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_group",
  "isRelative": false,
  "docPath": "docs/资产类别列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "资产类别保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_group_save",
  "isRelative": false,
  "docPath": "docs/资产类别保存.md"
}
};
...
module.exports = function createObject916e76Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
