...
const ENDPOINTS = {
  ...
  "title": "发货通知单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_delivery_notice",
  "isRelative": false,
  "docPath": "docs/发货通知单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "发货通知单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_delivery_notice_detail",
  "isRelative": false,
  "docPath": "docs/发货通知单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "发货通知单保存",
...
module.exports = function createObjectFaa066Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
