...
const ENDPOINTS = {
  ...
  "title": "辅助属性分类列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/aux_type",
  "isRelative": false,
  "docPath": "docs/辅助属性分类列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "辅助属性分类保存",
...
module.exports = function createObject2c8481Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
