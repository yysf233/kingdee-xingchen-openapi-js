...
write:upsert: 拣验货单下推 [POST https://api.kingdee.com/jdy/v2/scm/inv_pick_inspect_push]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "拣验货单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_pick_inspect",
  "isRelative": false,
  "docPath": "docs/拣验货单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "拣验货单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_pick_inspect_detail",
  "isRelative": false,
  "docPath": "docs/拣验货单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "拣验货单保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_pick_inspect_save",
  "isRelative": false,
  "docPath": "docs/拣验货单保存.md"
}
};
...
module.exports = function createObjectDd6914Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
