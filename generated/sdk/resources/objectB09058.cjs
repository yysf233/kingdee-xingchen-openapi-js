...
const ENDPOINTS = {
  ...
  "title": "税收分类编码类别列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/tax_category_type",
  "isRelative": false,
  "docPath": "docs/税收分类编码类别列表.md"
}
};
...
module.exports = function createObjectB09058Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
