...
read:list: 数量金额总账 [GET https://api.kingdee.com/jdy/v2/fi/qty_sum]; 科目余额表 [GET https://api.kingdee.com/jdy/v2/fi/account_balance_report]
read:detail: 核算项目明细账 [POST https://api.kingdee.com/jdy/v2/fi/assistdetail_report]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "辅助核算类别列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/assist_type_list",
  "isRelative": false,
  "docPath": "docs/辅助核算类别列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "明细账",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/sub_ledger_report",
  "isRelative": false,
  "docPath": "docs/明细账.md"
}
};
...
module.exports = function createObjectC6e965Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
