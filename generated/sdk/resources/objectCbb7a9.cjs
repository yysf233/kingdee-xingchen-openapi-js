...
const ENDPOINTS = {
  ...
  "title": "其他收入单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_other_credit",
  "isRelative": false,
  "docPath": "docs/其他收入单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "其他收入单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_other_credit_detail",
  "isRelative": false,
  "docPath": "docs/其他收入单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "其他收入单保存",
...
module.exports = function createObjectCbb7a9Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
