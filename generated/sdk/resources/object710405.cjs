...
const ENDPOINTS = {
  ...
  "title": "付款退款单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ap_pay_ret",
  "isRelative": false,
  "docPath": "docs/付款退款单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "付款退款单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ap_pay_ret_detail",
  "isRelative": false,
  "docPath": "docs/付款退款单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "付款退款单保存",
...
module.exports = function createObject710405Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
