...
const ENDPOINTS = {
  ...
  "title": "收款单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_credit",
  "isRelative": false,
  "docPath": "docs/收款单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "收款单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_credit_detail",
  "isRelative": false,
  "docPath": "docs/收款单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "收款单保存",
...
module.exports = function createObjectC4bb11Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
