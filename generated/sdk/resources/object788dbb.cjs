...
const ENDPOINTS = {
  ...
  "title": "物流公司列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/logistics_company",
  "isRelative": false,
  "docPath": "docs/物流公司列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "物流公司详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/logistics_company_detail",
  "isRelative": false,
  "docPath": "docs/物流公司详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "物流公司保存",
...
module.exports = function createObject788dbbApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
