...
const ENDPOINTS = {
  ...
  "title": "销售报价单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_quota",
  "isRelative": false,
  "docPath": "docs/销售报价单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "销售报价单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_quota_detail",
  "isRelative": false,
  "docPath": "docs/销售报价单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "销售报价单保存",
...
module.exports = function createObjectE78852Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
