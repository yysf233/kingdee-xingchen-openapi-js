...
const ENDPOINTS = {
  ...
  "title": "采购入库单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_inbound",
  "isRelative": false,
  "docPath": "docs/采购入库单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "采购入库单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_inbound_detail",
  "isRelative": false,
  "docPath": "docs/采购入库单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "采购入库单保存",
...
module.exports = function createObject8e1791Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
