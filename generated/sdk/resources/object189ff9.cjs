...
const ENDPOINTS = {
  ...
  "title": "辅助资料列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/aux_info",
  "isRelative": false,
  "docPath": "docs/辅助资料列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "辅助资料详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/aux_info_detail",
  "isRelative": false,
  "docPath": "docs/辅助资料详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "辅助资料保存",
...
module.exports = function createObject189ff9Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
