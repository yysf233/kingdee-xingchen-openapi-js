...
const ENDPOINTS = {
  ...
  "title": "销售退货申请单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_in_bound_request",
  "isRelative": false,
  "docPath": "docs/销售退货申请单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "销售退货申请单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_in_bound_request_detail",
  "isRelative": false,
  "docPath": "docs/销售退货申请单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "销售退货申请单保存",
...
module.exports = function createObject640a66Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
