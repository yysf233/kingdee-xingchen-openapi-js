...
read:list: BOM单列表 [GET https://api.kingdee.com/jdy/v2/bd/bom]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "产品查询BOM",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/bom_query",
  "isRelative": false,
  "docPath": "docs/产品查询BOM.md"
},
  detail: {
  "op": "read:detail",
  "title": "BOM单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/bom_detail",
  "isRelative": false,
  "docPath": "docs/BOM单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "BOM单保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/bom",
  "isRelative": false,
  "docPath": "docs/BOM单保存.md"
}
};
...
module.exports = function createBom4c2eafApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
