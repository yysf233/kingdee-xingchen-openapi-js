...
read:list: 盘点任务列表 [GET https://api.kingdee.com/jdy/v2/scm/inv_check_task]
write:upsert: 盘点任务单保存 [POST https://api.kingdee.com/jdy/v2/scm/inv_check_task]; 盘点单盈亏处理 [POST https://api.kingdee.com/jdy/v2/scm/inv_check_bill_gain_loss_deal]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "盘点单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_check_bill",
  "isRelative": false,
  "docPath": "docs/盘点单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "盘点单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_check_bill_detail",
  "isRelative": false,
  "docPath": "docs/盘点单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "盘点单保存",
...
module.exports = function createObject226986Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
