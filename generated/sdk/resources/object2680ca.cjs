...
const ENDPOINTS = {
  ...
  "title": "资产变动列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_alter_list",
  "isRelative": false,
  "docPath": "docs/资产变动列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "资产变动详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_alter_detail",
  "isRelative": false,
  "docPath": "docs/资产变动详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "资产变动保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_alter_save",
  "isRelative": false,
  "docPath": "docs/资产变动保存.md"
}
};
