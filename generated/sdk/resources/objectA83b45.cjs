...
read:list: 应收应付余额表 [GET https://api.kingdee.com/jdy/v2/arap/arap_balance]; 客户欠款余额 [GET https://api.kingdee.com/jdy/v2/arap/customer_debt]; 客户交易数据接口 [GET https://api.kingdee.com/jdy/v2/arap/customer_business]; 应付账款汇总表 [GET https://api.kingdee.com/jdy/v2/arap/ap_summary_report]; 应收账款汇总表 [GET https://api.kingdee.com/jdy/v2/arap/ar_summary_report]; 客户交易次数 [GET https://api.kingdee.com/jdy/v2/arap/customer_pay_number]; 供应商/客户对账单 [GET https://api.kingdee.com/jdy/v2/arap/reconciliation_statement]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "客户应收统计表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_report",
  "isRelative": false,
  "docPath": "docs/客户应收统计表.md"
},
  detail: {
  "op": "read:detail",
  "title": "应收账款明细表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_order_statement_report",
  "isRelative": false,
  "docPath": "docs/应收账款明细表.md"
}
};
...
module.exports = function createObjectA83b45Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
