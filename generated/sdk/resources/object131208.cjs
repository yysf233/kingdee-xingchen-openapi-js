...
const ENDPOINTS = {
  ...
  "title": "移仓单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_tfmove",
  "isRelative": false,
  "docPath": "docs/移仓单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "移仓单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_tfmove_detail",
  "isRelative": false,
  "docPath": "docs/移仓单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "移仓单保存",
...
module.exports = function createObject131208Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
