...
read:list: 商品单位列表 [GET https://api.kingdee.com/jdy/v2/bd/material_unit]
read:detail: 商品单位详情 [GET https://api.kingdee.com/jdy/v2/bd/material_unit_detail]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "计量单位列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/measure_unit",
  "isRelative": false,
  "docPath": "docs/计量单位列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "计量单位详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/measure_unit_detail",
  "isRelative": false,
  "docPath": "docs/计量单位详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "计量单位保存",
...
module.exports = function createObjectB310a9Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
