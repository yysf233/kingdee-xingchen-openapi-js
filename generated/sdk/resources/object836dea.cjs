...
const ENDPOINTS = {
  ...
  "title": "开发规范",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/sys/xxxxxx。",
  "isRelative": false,
  "docPath": "docs/开发规范.md"
}
};
...
module.exports = function createObject836deaApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
