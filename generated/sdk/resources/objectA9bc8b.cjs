...
const ENDPOINTS = {
  ...
  "title": "供应商分类列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/supplier_group",
  "isRelative": false,
  "docPath": "docs/供应商分类列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "供应商分类保存",
...
module.exports = function createObjectA9bc8bApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
