...
const ENDPOINTS = {
  ...
  "title": "收入类别分类列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/income_categorization",
  "isRelative": false,
  "docPath": "docs/收入类别分类列表.md"
}
};
...
module.exports = function createObject867099Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
