...
read:list: 调拨差异单列表 [GET https://api.kingdee.com/jdy/v2/scm/inv_tfdiff]
write:upsert: 调拨差异处理 [POST https://api.kingdee.com/jdy/v2/scm/inv_tfin_draw]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "调拨出库单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_tfout",
  "isRelative": false,
  "docPath": "docs/调拨出库单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "调拨出库单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_tfout_detail",
  "isRelative": false,
  "docPath": "docs/调拨出库单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "调拨出库单保存",
...
module.exports = function createObjectF4dbffApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
