...
const ENDPOINTS = {
  ...
  "title": "税收分类编码列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/tax_category_data",
  "isRelative": false,
  "docPath": "docs/税收分类编码列表.md"
}
};
...
module.exports = function createObject21fa54Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
