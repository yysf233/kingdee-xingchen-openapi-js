...
const ENDPOINTS = {
  ...
  "title": "调拨入库单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_tfin",
  "isRelative": false,
  "docPath": "docs/调拨入库单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "调拨入库单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_tfin_detail",
  "isRelative": false,
  "docPath": "docs/调拨入库单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "调拨入库单保存",
...
module.exports = function createObjectC1293cApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
