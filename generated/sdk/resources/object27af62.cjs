...
const ENDPOINTS = {
  ...
  "title": "委外加工单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/subm_workorder",
  "isRelative": false,
  "docPath": "docs/委外加工单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "委外加工单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/subm_workorder_detail",
  "isRelative": false,
  "docPath": "docs/委外加工单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "委外加工单保存",
...
module.exports = function createObject27af62Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
