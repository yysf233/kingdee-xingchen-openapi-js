...
const ENDPOINTS = {
  ...
  "title": "结算方式列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/settlement_type",
  "isRelative": false,
  "docPath": "docs/结算方式列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "结算方式保存",
...
module.exports = function createObject024777Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
