...
const ENDPOINTS = {
  ...
  "title": "生产退料单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_pick_ret",
  "isRelative": false,
  "docPath": "docs/生产退料单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "生产退料单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_pick_ret_detail",
  "isRelative": false,
  "docPath": "docs/生产退料单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "生产退料单保存",
...
module.exports = function createObjectEa898aApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
