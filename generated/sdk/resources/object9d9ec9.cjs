...
write:upsert: 自定义通用操作 [POST https://api.kingdee.com/jdy/v2/cust/operate]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "自定义接口列表",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/cust/list",
  "isRelative": false,
  "docPath": "docs/自定义接口列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "自定义接口详情",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/cust/detail",
  "isRelative": false,
  "docPath": "docs/自定义接口详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "自定义接口保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/cust/save",
  "isRelative": false,
  "docPath": "docs/自定义接口保存.md"
}
};
...
module.exports = function createObject9d9ec9Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
