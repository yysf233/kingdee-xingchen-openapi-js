...
const ENDPOINTS = {
  ...
  "title": "盘亏单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_check_loss_bill",
  "isRelative": false,
  "docPath": "docs/盘亏单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "盘亏单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_check_loss_bill_detail",
  "isRelative": false,
  "docPath": "docs/盘亏单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "盘亏单保存",
...
module.exports = function createObject4b6647Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
