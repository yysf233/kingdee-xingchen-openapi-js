...
read:list: 外部商品库列表 [GET https://api.kingdee.com/jdy/v2/bd/outside_material]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "商品列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/material",
  "isRelative": false,
  "docPath": "docs/商品列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "商品详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/material_detail",
  "isRelative": false,
  "docPath": "docs/商品详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "商品保存",
  ...
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/material",
  "isRelative": false,
  "docPath": "docs/商品保存.md"
},
  delete: {
  "op": "write:delete",
  "title": "商品图片删除",
  "method": "DELETE",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/material_picture",
  "isRelative": false,
  "docPath": "docs/商品图片删除.md"
}
};
...
module.exports = function createObject751c58Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
