...
const ENDPOINTS = {
  ...
  "title": "资产列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_card",
  "isRelative": false,
  "docPath": "docs/资产列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "资产详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_card_detail",
  "isRelative": false,
  "docPath": "docs/资产详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "资产保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_card_save",
  "isRelative": false,
  "docPath": "docs/资产保存.md"
}
};
...
module.exports = function createObject713fd9Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
