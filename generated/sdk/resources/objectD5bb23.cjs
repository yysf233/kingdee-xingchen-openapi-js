...
const ENDPOINTS = {
  ...
  "title": "报销单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/ebx/reimb_detail",
  "isRelative": false,
  "docPath": "docs/报销单详情.md"
}
};
...
module.exports = function createObjectD5bb23Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
