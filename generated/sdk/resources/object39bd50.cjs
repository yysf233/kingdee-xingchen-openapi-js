...
const ENDPOINTS = {
  ...
  "title": "日记账列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/journal",
  "isRelative": false,
  "docPath": "docs/日记账列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "日记账详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/journal_detail",
  "isRelative": false,
  "docPath": "docs/日记账详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "日记账保存",
...
module.exports = function createObject39bd50Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
