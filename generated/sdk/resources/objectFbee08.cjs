...
const ENDPOINTS = {
  ...
  "title": "科目类别列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/account_type",
  "isRelative": false,
  "docPath": "docs/科目类别列表.md"
}
};
...
module.exports = function createObjectFbee08Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
