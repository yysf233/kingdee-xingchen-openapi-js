...
const ENDPOINTS = {
  ...
  "title": "销售换货申请单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_exchange_request",
  "isRelative": false,
  "docPath": "docs/销售换货申请单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "销售换货申请单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_exchange_request_detail",
  "isRelative": false,
  "docPath": "docs/销售换货申请单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "销售换货申请单保存",
...
module.exports = function createObject2c4dc9Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
