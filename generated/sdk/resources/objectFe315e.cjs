...
const ENDPOINTS = {
  ...
  "title": "外部单据分类列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/virtual_type",
  "isRelative": false,
  "docPath": "docs/外部单据分类列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "外部单据分类保存",
...
module.exports = function createObjectFe315eApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
