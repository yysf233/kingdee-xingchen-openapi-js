...
const ENDPOINTS = {
  ...
  "title": "采购申请单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_request",
  "isRelative": false,
  "docPath": "docs/采购申请单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "采购申请单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_request_detail",
  "isRelative": false,
  "docPath": "docs/采购申请单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "采购申请单保存",
...
module.exports = function createObject00c66cApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
