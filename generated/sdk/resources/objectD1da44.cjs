...
write:upsert: 销售出库单批量保存 [POST https://api.kingdee.com/jdy/v2/scm/sal_out_bound_batch]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "销售出库单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_out_bound",
  "isRelative": false,
  "docPath": "docs/销售出库单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "销售出库单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_out_bound_detail",
  "isRelative": false,
  "docPath": "docs/销售出库单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "销售出库单保存",
...
module.exports = function createObjectD1da44Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
