...
const ENDPOINTS = {
  ...
  "title": "收料通知单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_mat_rec_notice",
  "isRelative": false,
  "docPath": "docs/收料通知单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "收料通知单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_mat_rec_notice_detail",
  "isRelative": false,
  "docPath": "docs/收料通知单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "收料通知单保存",
...
module.exports = function createObjectBd25f4Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
