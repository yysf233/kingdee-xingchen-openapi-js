...
const ENDPOINTS = {
  ...
  "title": "工资单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/sa_bill",
  "isRelative": false,
  "docPath": "docs/工资单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "工资单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/sa_bill_detail",
  "isRelative": false,
  "docPath": "docs/工资单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "工资单保存",
...
module.exports = function createObject895170Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
