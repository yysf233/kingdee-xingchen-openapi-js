...
read:list: 储值流水查询 [GET https://api.kingdee.com/jdy/v2/ls/recharge_record]; 积分流水查询 [GET https://api.kingdee.com/jdy/v2/ls/integral_record]; 充值赠送规则 [GET https://api.kingdee.com/jdy/v2/ls/mall_recharge_rule]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "积分规则查询",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/ls/point_rule",
  "isRelative": false,
  "docPath": "docs/积分规则查询.md"
}
};
...
module.exports = function createObjectF09974Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
