...
read:list: 委托代销退货列表 [GET https://api.kingdee.com/jdy/v2/scm/entrust_rtn]
read:detail: 委托代销退货详情 [GET https://api.kingdee.com/jdy/v2/scm/entrust_rtn_detail]
write:upsert: 委托代销退货保存 [POST https://api.kingdee.com/jdy/v2/scm/entrust_rtn]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "委托代销列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/entrust",
  "isRelative": false,
  "docPath": "docs/委托代销列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "委托代销详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/entrust_detail",
  "isRelative": false,
  "docPath": "docs/委托代销详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "委托代销保存",
...
module.exports = function createObject54b08cApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
