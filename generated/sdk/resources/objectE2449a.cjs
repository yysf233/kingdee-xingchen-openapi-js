...
const ENDPOINTS = {
  ...
  "title": "拆卸单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_disassemble",
  "isRelative": false,
  "docPath": "docs/拆卸单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "拆卸单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_disassemble_detail",
  "isRelative": false,
  "docPath": "docs/拆卸单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "拆卸单保存",
...
module.exports = function createObjectE2449aApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
