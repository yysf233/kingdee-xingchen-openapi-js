...
const ENDPOINTS = {
  ...
  "title": "职员列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/emp",
  "isRelative": false,
  "docPath": "docs/职员列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "职员详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/emp_detail",
  "isRelative": false,
  "docPath": "docs/职员详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "职员保存",
...
module.exports = function createObjectA18544Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
