...
const ENDPOINTS = {
  ...
  "title": "商品价格策略",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/material_price",
  "isRelative": false,
  "docPath": "docs/商品价格策略.md"
}
};
...
module.exports = function createObject0e6bacApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
