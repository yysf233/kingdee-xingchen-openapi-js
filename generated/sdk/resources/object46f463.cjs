...
const ENDPOINTS = {
  ...
  "title": "委外产品入库单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/subm_prodin",
  "isRelative": false,
  "docPath": "docs/委外产品入库单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "委外产品入库单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/subm_prodin_detail",
  "isRelative": false,
  "docPath": "docs/委外产品入库单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "委外产品入库单保存",
...
module.exports = function createObject46f463Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
