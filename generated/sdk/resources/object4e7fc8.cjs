...
const ENDPOINTS = {
  ...
  "title": "仓库分类列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/store_group",
  "isRelative": false,
  "docPath": "docs/仓库分类列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "仓库分类详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/store_group_detail",
  "isRelative": false,
  "docPath": "docs/仓库分类详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "仓库分类保存",
...
module.exports = function createObject4e7fc8Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
