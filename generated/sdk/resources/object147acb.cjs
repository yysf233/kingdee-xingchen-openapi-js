...
const ENDPOINTS = {
  ...
  "title": "其他入库单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_other_in",
  "isRelative": false,
  "docPath": "docs/其他入库单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "其他入库单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_other_in_detail",
  "isRelative": false,
  "docPath": "docs/其他入库单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "其他入库单保存",
...
module.exports = function createObject147acbApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
