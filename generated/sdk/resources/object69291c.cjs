...
const ENDPOINTS = {
  ...
  "title": "商品品牌列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/material_brand",
  "isRelative": false,
  "docPath": "docs/商品品牌列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "商品品牌详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/material_brand_detail",
  "isRelative": false,
  "docPath": "docs/商品品牌详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "商品品牌保存",
...
module.exports = function createObject69291cApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
