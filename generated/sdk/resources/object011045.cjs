...
const ENDPOINTS = {
  ...
  "title": "存放地点列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_location",
  "isRelative": false,
  "docPath": "docs/存放地点列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "存放地点保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_location_save",
  "isRelative": false,
  "docPath": "docs/存放地点保存.md"
}
};
...
module.exports = function createObject011045Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
