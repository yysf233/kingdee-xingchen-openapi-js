...
const ENDPOINTS = {
  ...
  "title": "客户分类列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/customer_group",
  "isRelative": false,
  "docPath": "docs/客户分类列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "客户分类保存",
...
module.exports = function createObject7068c5Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
