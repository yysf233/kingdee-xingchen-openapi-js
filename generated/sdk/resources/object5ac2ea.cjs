...
const ENDPOINTS = {
  ...
  "title": "币别列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/currency",
  "isRelative": false,
  "docPath": "docs/币别列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "币别详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/currency_detail",
  "isRelative": false,
  "docPath": "docs/币别详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "币别保存",
...
module.exports = function createObject5ac2eaApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
