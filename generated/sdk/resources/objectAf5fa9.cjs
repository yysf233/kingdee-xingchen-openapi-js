...
read:list: 委托代销结算退货列表 [GET https://api.kingdee.com/jdy/v2/scm/entrust_settle_rtn]
read:detail: 委托代销结算退货详情 [GET https://api.kingdee.com/jdy/v2/scm/entrust_settle_rtn_detail]
write:upsert: 委托代销结算退货保存 [POST https://api.kingdee.com/jdy/v2/scm/entrust_settle_rtn]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "委托代销结算列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/entrust_settle",
  "isRelative": false,
  "docPath": "docs/委托代销结算列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "委托代销结算详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/entrust_settle_detail",
  "isRelative": false,
  "docPath": "docs/委托代销结算详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "委托代销结算保存",
...
module.exports = function createObjectAf5fa9Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
