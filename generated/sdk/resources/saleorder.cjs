...
const ENDPOINTS = {
  ...
  "title": "销售订单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_order",
  "isRelative": false,
  ...
  "title": "销售订单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_order_detail",
  "isRelative": false,
...
module.exports = function createSaleOrderApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
