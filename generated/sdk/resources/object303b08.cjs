...
const ENDPOINTS = {
  ...
  "title": "盘盈单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_check_gail_bill",
  "isRelative": false,
  "docPath": "docs/盘盈单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "盘盈单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_check_gail_bill_detail",
  "isRelative": false,
  "docPath": "docs/盘盈单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "盘盈单保存",
...
module.exports = function createObject303b08Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
