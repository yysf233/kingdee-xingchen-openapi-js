...
read:list: 零售单汇总查询 [GET https://api.kingdee.com/jdy/v2/ls/retail_bill_statistic]
write:upsert: 零售单保存 [POST https://api.kingdee.com/jdy/v2/ls/retail_bill]; 零售单退货 [POST https://api.kingdee.com/jdy/v2/ls/retail_bill_return]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "零售单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/ls/retail_bill",
  "isRelative": false,
  "docPath": "docs/零售单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "零售单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/ls/retail_bill_detail",
  "isRelative": false,
  "docPath": "docs/零售单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "零售退款保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/ls/refundSave",
  "isRelative": false,
  "docPath": "docs/零售退款保存.md"
}
};
...
module.exports = function createObject670a26Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
