...
const ENDPOINTS = {
  ...
  "title": "凭证附件列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/voucher_attachment",
  "isRelative": false,
  "docPath": "docs/凭证附件列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "凭证附件上传",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/voucher_attachment_upload",
  "isRelative": false,
  "docPath": "docs/凭证附件上传.md"
}
};
...
module.exports = function createObject7720bcApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
