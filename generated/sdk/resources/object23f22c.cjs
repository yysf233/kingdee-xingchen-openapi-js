...
const ENDPOINTS = {
  ...
  "title": "变动方式列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_altermode",
  "isRelative": false,
  "docPath": "docs/变动方式列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "变动方式保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_altermode_save",
  "isRelative": false,
  "docPath": "docs/变动方式保存.md"
}
};
...
module.exports = function createObject23f22cApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
