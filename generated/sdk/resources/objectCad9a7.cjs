...
write:upsert: 凭证冲销 [POST https://api.kingdee.com/jdy/v2/fi/voucher_reverse]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "凭证列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/voucher",
  "isRelative": false,
  "docPath": "docs/凭证列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "凭证详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/voucher_detail",
  "isRelative": false,
  "docPath": "docs/凭证详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "凭证保存",
...
module.exports = function createObjectCad9a7Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
