...
const ENDPOINTS = {
  ...
  "title": "支出类别分类列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/pay_out_type_group_list",
  "isRelative": false,
  "docPath": "docs/支出类别分类列表.md"
}
};
...
module.exports = function createObject0e79b8Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
