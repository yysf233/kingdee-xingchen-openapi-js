...
const ENDPOINTS = {
  ...
  "title": "商品分类列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/material_group",
  "isRelative": false,
  "docPath": "docs/商品分类列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "商品分类详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/material_group_detail",
  "isRelative": false,
  "docPath": "docs/商品分类详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "商品分类保存",
...
module.exports = function createObject09482dApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
