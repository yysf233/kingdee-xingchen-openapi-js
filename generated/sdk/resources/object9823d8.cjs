...
const ENDPOINTS = {
  ...
  "title": "账户列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/settlement_account",
  "isRelative": false,
  "docPath": "docs/账户列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "账户保存",
...
module.exports = function createObject9823d8Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
