...
read:list: 材料分录联动查询 [POST https://api.kingdee.com/jdy/v2/pm/bom_material]
*/
const ENDPOINTS = {
  list: {
  "op": "read:list",
  "title": "生产任务单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/mo_taskbill",
  "isRelative": false,
  "docPath": "docs/生产任务单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "生产任务单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/mo_taskbill_detail",
  "isRelative": false,
  "docPath": "docs/生产任务单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "生产任务单保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/pm/mo_task_bill",
  "isRelative": false,
  "docPath": "docs/生产任务单保存.md"
}
};
...
module.exports = function createObject919a38Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
