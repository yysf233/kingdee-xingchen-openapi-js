...
const ENDPOINTS = {
  ...
  "title": "预收退款单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_pre_credit_ret",
  "isRelative": false,
  "docPath": "docs/预收退款单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "预收退款单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ar_pre_credit_ret_detail",
  "isRelative": false,
  "docPath": "docs/预收退款单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "预收退款单保存",
...
module.exports = function createObjectFc4899Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
