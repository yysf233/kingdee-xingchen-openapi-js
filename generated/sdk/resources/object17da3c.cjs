...
const ENDPOINTS = {
  ...
  "title": "商品标签保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/material_label",
  "isRelative": false,
  "docPath": "docs/商品标签保存.md"
}
};
...
module.exports = function createObject17da3cApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
