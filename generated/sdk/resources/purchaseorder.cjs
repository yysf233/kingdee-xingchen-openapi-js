...
const ENDPOINTS = {
  ...
  "title": "采购订单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_order",
  "isRelative": false,
  "docPath": "docs/采购订单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "采购订单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_order_detail",
  "isRelative": false,
  "docPath": "docs/采购订单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "采购订单保存",
  ...
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_order",
  "isRelative": false,
  "docPath": "docs/采购订单保存.md"
},
  cancel: {
  "op": "workflow:cancel",
  "title": "采购订单取消",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/pur_order_cancel",
  "isRelative": false,
  "docPath": "docs/采购订单取消.md"
}
};
...
module.exports = function createPurchaseOrderApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
  ...
  api.cancel = async function cancel({ id } = {}, opts = {}) {
    if (id === undefined) throw new Error("cancel({id}) requires id");
    const resp = await callEndpoint("cancel", { id }, opts);
    assertBusinessSuccess("cancel", resp);
    await verifyReadAfterWrite("cancel", { id }, opts);
    return resp;
  };
