...
const ENDPOINTS = {
  ...
  "title": "使用状态列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_usestatus",
  "isRelative": false,
  "docPath": "docs/使用状态列表.md"
},
  save: {
  "op": "write:upsert",
  "title": "使用状态保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/fi/fa_usestatus_save",
  "isRelative": false,
  "docPath": "docs/使用状态保存.md"
}
};
...
module.exports = function createObject3a5cacApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
