...
const ENDPOINTS = {
  ...
  "title": "预付退款单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ap_pre_credit_ret",
  "isRelative": false,
  "docPath": "docs/预付退款单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "预付退款单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/arap/ap_pre_credit_ret_detail",
  "isRelative": false,
  "docPath": "docs/预付退款单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "预付退款单保存",
...
module.exports = function createObjectF84752Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
