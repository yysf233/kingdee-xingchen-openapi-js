...
const ENDPOINTS = {
  ...
  "title": "辅助资料分类列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/aux_info_type",
  "isRelative": false,
  "docPath": "docs/辅助资料分类列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "辅助资料分类详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/aux_info_type_detail",
  "isRelative": false,
  "docPath": "docs/辅助资料分类详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "辅助资料分类保存",
...
module.exports = function createObject3e023dApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
