...
const ENDPOINTS = {
  ...
  "title": "其他出库单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_other_out",
  "isRelative": false,
  "docPath": "docs/其他出库单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "其他出库单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/inv_other_out_detail",
  "isRelative": false,
  "docPath": "docs/其他出库单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "其他出库单保存",
...
module.exports = function createObjectCf1e54Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
