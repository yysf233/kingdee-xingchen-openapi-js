...
const ENDPOINTS = {
  ...
  "title": "销售发票单列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_invoice_list",
  "isRelative": false,
  "docPath": "docs/销售发票单列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "销售发票单详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_invoice_detail",
  "isRelative": false,
  "docPath": "docs/销售发票单详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "销售发票单保存",
  "method": "POST",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/scm/sal_invoice",
  "isRelative": false,
  "docPath": "docs/销售发票单保存.md"
}
};
...
module.exports = function createObject7f6512Api({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
