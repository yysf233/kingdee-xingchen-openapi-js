...
const ENDPOINTS = {
  ...
  "title": "部门列表",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/department",
  "isRelative": false,
  "docPath": "docs/部门列表.md"
},
  detail: {
  "op": "read:detail",
  "title": "部门详情",
  "method": "GET",
  "pathOrUrl": "https://api.kingdee.com/jdy/v2/bd/department_detail",
  "isRelative": false,
  "docPath": "docs/部门详情.md"
},
  save: {
  "op": "write:upsert",
  "title": "部门保存",
...
module.exports = function createObject91061aApi({ client, openapiHost = process.env.OPENAPI_HOST || "https://api.kingdee.com", overrideHost = false } = {}) {
